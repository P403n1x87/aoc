...
are **fresh** and which are **spoiled**. When you ask how it works, they give
...
`3`, `4`, and `5` are all **fresh**. The ranges can also **overlap**; an
...
like to know **all** of the IDs that the **fresh ingredient ID ranges** consider
to be **fresh**. An ingredient ID is still considered fresh if it is in any
range.
...
this example, the fresh ingredient ID ranges consider a total of **`14`**
