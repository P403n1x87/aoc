...
rather that the issue is triggered by data following some specific **path**
...
says **`you`**) and ending with the main output to the reactor (which is the
...
`dac` (a [digital-to-analog converter](https://en.wikipedia.org/wiki/Digital-to-
analog_converter)) and `fft` (a device which performs a [fast Fourier
